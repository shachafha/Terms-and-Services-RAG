Terms & Conditions of Use of DoneDeal
=====================================
...
You agree and acknowledge that DoneDeal.ie is an information society service provider, as defined in Directive 2000/31/EC (as transposed into Irish law by the European Communities (Directive 2000/31/ EC) Regulations, 2003 (S.I. 68 of 2003)) and Article 1(1)(b) of Directive (EU) 2015/1535, and that it is not under any obligations to monitor the information which it transmits or stores on the Sites. You agree and acknowledge that DoneDeal.ie shall not be liable in respect of information which is hosted or cached by it or in respect of which it acts as a mere conduit. You acknowledge that the provisions of Regulation (EU) 2022/2065 (the “Digital Services Act”) shall apply to such information, and that where DoneDeal.ie has not been given substantiated notice outlining the nature of illegal content hosted or cached on its platform, it shall not be considered to have actual knowledge or awareness of such illegal content being hosted or cached on its platform, and it shall be under no obligation to take any positive action to remove such illegal content. DoneDeal.ie operates a “notice and take down” policy, and shall, in line with its obligations under the Digital Services Act, remove or disable access to illegal content in circumstances where it has received substantiated notice of such content being hosted or cached on its platform outlining the nature of the illegal content.

Without any admission of liability, we may from time to time assess any possible risks for users from third parties when they use the Website and/or the DoneDeal Service, and we will decide in each case whether it is appropriate to use moderation or pre-approval of advertisements on the Website (including what kind of moderation to use) in the light of those risks. We will also assess any notices we receive that any user content on our Website is illegal which may result in the content and/or a user account being suspended or terminated. By way of example of the type of moderation conducted by us, we may use the following methods:

1. manual review of content that has been reported to us for the purpose of preventing fraudulent, harmful or illegal content, and ensuring safety of the Website; and
2. the use of key word filtering at the time of ad-creation to monitor the advertisement or promotion of prohibited items or the use of discriminatory terms.
...
DoneDeal.ie  will comply with any statutory obligations in respect of the removal of such offending content (including where required by law informing the user of the reasons for such removal and allowing a right of appeal) and shall otherwise use all reasonable endeavours to remove the offending content complained about within a reasonable period of time, where it finds that such content in breach of the Terms of Use. Any content reported to us will be reviewed from 9am to 5pm, Monday to Friday, excluding national and public holidays in the Republic of Ireland. Any notification received outside of the aforementioned hours will only be addressed upon the reopening of DoneDeal.ie offices.

You have the right to be informed of the identity of the person on whose behalf an advertisement on DoneDeal is presented if a fee was paid by the advertiser for the advertisement.  If you would like to make a request for the name of an advertiser, please email \[ support@distilleddsa.zendesk.com \] and include details of the reason for your request.   
...
* post or use any material that is obscene, defamatory, discriminatory, seditious, indecent, offensive, incite racial hatred or which otherwise constitutes hate speech or incites a crime or the commission of terrorist acts, be naming or scandalous or inappropriate or the non-consensual sharing of private images;
...
* upload, post, transmit or otherwise make available using the Website any material or advertise or sell any item using the Website which is not in compliance with law or which is advertised or sold for a use which is not in compliance with law, including but not limited to any devices or technology designed to circumvent copyright or rightholder restrictions, counterfeit goods or any material which otherwise relates to the promotion of illegal activities; and/or
* upload, post, transmit or otherwise make available using the Website any material which is not in compliance with the applicable Policies, which include: [Electronics and Software Policy](https://hello.donedeal.ie/hc/en-us/articles/201251671-Electronics-and-Software-Policy-); [Firearms and Knives Policy](https://hello.donedeal.ie/hc/en-us/articles/201120892-Firearms-and-Knives-Policy); and [Animal Policies](https://hello.donedeal.ie/hc/en-us/articles/201121882-Animal-Policies).
...
[Privacy & Cookie Policy](https://hello.donedeal.ie/hc/en-us/articles/201251721-Privacy-Policy)

**12\. Suspension and termination**

We may immediately delete your advertisement and terminate your access to the DoneDeal Service or a User Identifier without prior notice at our sole discretion. The deletion or otherwise of an advertisement should not be viewed as an indication of wrongdoing on the part of the advertiser.  Users will be provided with a statement of reasons for termination or suspension and shall have the opportunity to clarify the facts and circumstances leading to their suspension or termination within the framework of our internal complaint-handling process, as described in more detail in Clause 19 below, with respect to Business Users and Clause 13 below, with respect to all other Users.

Without limiting the foregoing, the following may lead to a deletion by us of a user’s advertisement and/or termination or suspension of access to the DoneDeal Service: (a) a breach of the User Agreement; (b) the posting of manifestly illegal content on the DoneDeal.ie platform (including, for example, the sale of products that are manifestly not permitted for sale in Ireland such as firearms or explosives, unlicensed pharmaceutical products etc); (c) the making of manifestly unfounded notices or complaints in relation to illegal content on the  platform (including, for example, the provision of false information in relation to such notices or false impersonation) (d) a request by law enforcement, An Garda Síochána / PSNI, police or other government agencies about you or any Content that you have submitted to us; (e) a request by you (self-initiated deletion(s)); (f) unexpected technical issues or problems; and (g) extended periods of inactivity. 

In relation to suspension of access to the DoneDeal service, you agree that suspension of your use of the Website by us shall be made in our sole discretion.  The facts and circumstances taken into account when assessing whether certain behaviour constitutes misuse requiring suspension or when determining the duration of any suspension, include the gravity of the misuse (for example, the nature of any illegal content uploaded) and the repeated nature of the behaviour.

In particular, your account with us may be terminated with immediate effect if we suspect you have engaged in any fraudulent, illegal or misleading activity on our Website.  Deletion of a user advertisement and termination of access to the DoneDeal Service may result in the removal of all Content that we may decide to delete. It may also result in preventing your further use of the Website or a User Identifier, depending on the circumstances. Furthermore, you agree that termination of the user Agreement or your use of the Website by us shall be made in our sole discretion and that we shall not be liable to you nor any third party for any termination of your account or access to the Website or removal of Content. You can view further information about how we process your data by reading our [Privacy Policy](https://hello.donedeal.ie/hc/en-us/articles/201251721-Privacy-Policy).
...
You have the right to lodge a complaint against decisions we take to suspend or terminate your access to the platform, if such access has been suspended or terminated on the grounds that the information you provided on the platform constitutes illegal content or was otherwise incompatible with the Terms of Use. Please see Clause 13 below.

**13\. Your concerns and complaints**

If you have any concerns about material which appears on the Website or if you believe that Content posted on the Website breaches the User Agreement or is in any other way objectionable or illegal, please notify us through the ‘Report this Ad’ mechanism on the Website or send a letter to DoneDeal.ie, Crescent House, Crescent Quay, Wexford, Y35 HE67, Ireland specifying the full details of your concern or complaint, specifying the reasons for your concern or complaint making clear reference to any connected such Content.
...
If you are reporting content as illegal under the Digital Services Act, please provide us with a detailed explanation detailing why the content is illegal. If the report does not contain enough information for us to clearly assess whether the content is illegal, we will not be able to progress the report. We are not obliged to take any action in respect of a notice or complaint that is not sufficiently substantiated. If you frequently submit reports of illegal content under the Digital Services Act that are manifestly unfounded, we reserve the right to suspend your ability to submit reports. 

If you are unhappy with decisions we have taken in relation to content that appears on the Website or decisions we have taken in relation to your access to the Website, you have the right to lodge a complaint within six months following the decision. You have the right to lodge a complaint against decisions we take to:

1. remove or disable access to content; or
2. suspend or terminate access to the Website.

The complaint-handling process begins by the user submitting a complaint free of charge to the following email address \[ [appeals@distilleddsa.zendesk.com](mailto:appeals@distilleddsa.zendesk.com) \].  The process then proceeds as follows:

1. You will receive an automated acknowledgement of your email once your complaint is received. A designated case officer within DoneDeal will be assigned to your complaint and will make initial contact with you in a timely manner.  Depending on the nature of the complaint alleged, the case officer may request additional supporting information to assess your complaint.
...
3. Following a comprehensive review of the information provided, the case officer will communicate his/her decision to you promptly following receipt of all requested information.

We endeavour to handle and settle disputes and complaints in an amicable manner internally.  However, if you are unhappy with the final outcome, you have the right to refer the matter to an out-of-court dispute settlement body. Business Users should refer to Clause 19 below.
...
If you pay a Fee for the publication of an advertisement on DoneDeal, DoneDeal is required by law to provide your full name to any recipient of the advertisement.  DoneDeal may provide this information on receipt of a request from individuals who view the advertisement.
...
Please note that the content of the published advertisements is provided by external users, and do not represent any views or opinions of DoneDeal.ie, nor should they purport to do so.
...
The ranking of advertisements in search results on our Website depends on a variety of factors.  In particular, certain search results may rank products according to the following parameters:

1. whether a premium has been paid for an advertisement;
2. whether the user has manually applied filtering to a search, or used the "sort" functionality; and
3. in certain circumstances, based on a user’s previous search activity on the Website. 

A user can influence the parameters applied by altering the search such as filtering results by location, price range and technical specifications.
